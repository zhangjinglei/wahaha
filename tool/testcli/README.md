...
*这个是testing/lich的二进制工具版本（Go请直接使用库版本：github.com/zhangjinglei/wahaha/pkg/testing/lich)*
...
```shell
go get -u github.com/zhangjinglei/wahaha/tool/testcli
$GOPATH/bin/testcli -h
```
#### Method 2. Build with Go
```shell
cd github.com/zhangjinglei/wahaha/tool/testcli
go build -o $GOPATH/bin/testcli
$GOPATH/bin/testcli -h
```
#### Method 3. Import with Kratos pkg
```Go
import "github.com/zhangjinglei/wahaha/pkg/testing/lich"
```
...
- Step1. 在 Dao|Service 层中的 TestMain 单测主入口中，import  "github.com/zhangjinglei/wahaha/pkg/testing/lich" 引入testcli工具的go库版本。
...
import (
    ...
    "github.com/zhangjinglei/wahaha/pkg/testing/lich"
 )

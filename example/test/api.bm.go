...
func RegisterUserBMServer(e *bm.Engine, server UserBMServer, permission map[string][]string) {
	UserSvc = server
	//zhangjinglei
	permission["/user.api.User/Info"] = []string{"a", "b", "c"}
	e.GET("/user.api.User/Info", userInfo)
	//zhangjinglei
	permission["/user.api.User/Card"] = []string{"a", "b", "c"}
